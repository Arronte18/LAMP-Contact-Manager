  ...
  try {
      xhr.onreadystatechange = function () {
          ...
          if (this.status == 200) {
              ...
              // document.getElementById("registerResult").innerHTML = "User Successfully Added";
...
function newSaveEditCookie()
{
  ...
  document.cookie = "userId=" + userId + ",id=" + id + ",firstname=" + editFirstName + ",lastname=" + editLastName +
...
// FIX THIS
// Needs to throw user back to Contacts Page
function addContact()
{
  readCookie();
  ...
  try
  {
    ...
    xhr.onreadystatechange = function()
    {
      if (this.readyState == 4 && this.status == 200)
      {
        ...
        // Display this somewher by creating element with contactAddResult as id ===========
    ...
    xhr.onreadystatechange = function()
    {
      if (this.readyState == 4 && this.status == 200)
      {
        ...
        for (let i = 0; i < jsonObject.contacts.length; i++) {
            ...
            tableBodyData += "<td id='edit" + i + "'><a href='EditContactPage.html' class='fa-solid fa-user-pen' onclick='row("+ i +");newSaveEditCookie();'></a></td>";
            // setEditValues(firstName" + i + ", lastName" + i + ", email" + i + ", phoneNumber" + i + ", address" + i + ", city" + i + ", state" + i + ");'></a></td>";
